...
import com.ziyao.ideal.boot.autoconfigure.redis.config.RepositoryConfiguration;
import com.ziyao.ideal.boot.autoconfigure.redis.config.RepositoryConfigurationExtension;
import com.ziyao.ideal.boot.autoconfigure.redis.config.RepositoryConfigurationSource;
...
public class RedisRepositoryConfigurationDelegate {
    ...
    private static Environment defaultEnvironment(@Nullable Environment environment,
        ...
        if (resourceLoader instanceof EnvironmentCapable) {
            EnvironmentCapable environmentCapable = (EnvironmentCapable) resourceLoader;
