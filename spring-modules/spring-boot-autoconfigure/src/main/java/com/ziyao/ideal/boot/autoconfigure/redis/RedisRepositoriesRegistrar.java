...
import com.ziyao.ideal.boot.autoconfigure.redis.config.AnnotationRepositoryConfigurationSource;
import com.ziyao.ideal.boot.autoconfigure.redis.config.RedisRepositoryConfigurationExtension;
import com.ziyao.ideal.boot.autoconfigure.redis.config.RepositoryConfigurationExtension;
import com.ziyao.ideal.boot.autoconfigure.redis.config.RepositoryConfigurationUtils;
import com.ziyao.ideal.boot.autoconfigure.redis.support.Streamable;
import com.ziyao.ideal.boot.autoconfigure.redis.type.AnnotationMetadataUtils;
