...
import com.ziyao.ideal.core.codec.Base16Codec;
import com.ziyao.ideal.core.codec.Decoder;
 ...
 * <p>
 * <a href="https://my.oschina.net/xinxingegeya/blog/287476">参考</a>
 *
 * @author ziyao zhang
 */
public abstract class HexUtils {
    ...
    public static Decoder<CharSequence, byte[]> getEncoder(boolean toLowerCase) {
        return toLowerCase ? Base16Codec.CODEC_LOWER : Base16Codec.CODEC_UPPER;
    }

    public static Decoder<CharSequence, byte[]> getDecoder(boolean toLowerCase) {
        return toLowerCase ? Base16Codec.CODEC_LOWER : Base16Codec.CODEC_UPPER;
    }
    ...
    public static char[] encodeHex(String str, Charset charset) {
        return encodeHex(Strings.toBytes(str, charset), true);
    }
    ...
    public static String encodeHexStr(String data, Charset charset) {
        return encodeHexStr(Strings.toBytes(data, charset), true);
    }
    ...
    public static String encodeHexStr(String data) {
        return encodeHexStr(data, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(String hexStr) {
        return decodeHexStr(hexStr, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(String hexStr, Charset charset) {
        if (Strings.isEmpty(hexStr)) {
            return hexStr;
        }
        return Strings.toString(decodeHex(hexStr), charset);
    }
    ...
    public static String decodeHexStr(char[] hexData, Charset charset) {
        return Strings.toString(decodeHex(hexData), charset);
    }
    ...
    public static String format(String hexStr) {
        ...
        final StringBuilder builder = Strings.builder(length + length / 2);
