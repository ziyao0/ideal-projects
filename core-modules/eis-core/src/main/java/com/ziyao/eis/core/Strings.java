...
import com.ziyao.eis.core.text.StrPool;
import com.ziyao.eis.core.text.StringFinder;
import com.ziyao.eis.core.text.StringFormatter;
...
public abstract class Strings implements StrPool {
    ...
    public static String collectionToDelimitedString(Collection<?> coll, String delim, String prefix, String suffix) {
        ...
        if (com.ziyao.eis.core.Collections.isEmpty(coll)) {
            return "";
        }
