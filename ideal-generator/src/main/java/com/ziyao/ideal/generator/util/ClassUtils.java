...
public final class ClassUtils {
    ...
    public static <T> T newInstance(Class<T> clazz) {
        try {
            ...
            throw new RuntimeException("实例化对象时出现错误,请尝试给 %s 添加无参的构造方法 =" + clazz.getName(), e);
        }
    }
    ...
    public static <T> T newInstance(String clazzName) {
        return (T) newInstance(toClassConfident2(clazzName));
    }
     ...
     * @return 返回转换后的 Class
     */
    public static Class<?> toClassConfident2(String name) {
    ...
    public static String getPackageName(String fqClassName) {
        ...
        int lastDotIndex = fqClassName.lastIndexOf(Strings.DOT);
        return (lastDotIndex != -1 ? fqClassName.substring(0, lastDotIndex) : Strings.EMPTY);
    }
    ...
    public static String getSimpleName(String className) {
        return Strings.isEmpty(className) ? null : className.substring(className.lastIndexOf(Strings.DOT) + 1);
    }
