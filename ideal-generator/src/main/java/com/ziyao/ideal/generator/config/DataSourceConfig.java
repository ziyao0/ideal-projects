...
import com.ziyao.ideal.generator.config.converts.MySqlTypeConvert;
import com.ziyao.ideal.generator.config.converts.TypeConverts;
import com.ziyao.ideal.generator.config.querys.DbQueryDecorator;
import com.ziyao.ideal.generator.config.querys.DbQueryRegistry;
import com.ziyao.ideal.generator.mybatisplus.DbType;
import com.ziyao.ideal.generator.query.AbstractDatabaseQuery;
import com.ziyao.ideal.generator.query.DefaultQuery;
import com.ziyao.ideal.generator.query.IDatabaseQuery;
import com.ziyao.ideal.generator.query.SQLQuery;
...
public class DataSourceConfig {
     ...
     */
    @NonNull
    private DbType getDbType(@NonNull String str) {
    ...
    public static class Builder implements IConfigBuilder<DataSourceConfig> {
         ...
         */
        public Builder(@NonNull String url, String username, String password) {
            this();
         ...
         */
        public Builder(@NonNull DataSource dataSource) {
            this();
         ...
         * @return this
         */
        public Builder dbQuery(@NonNull IDbQuery dbQuery) {
         ...
         * @return this
         */
        public Builder schema(@NonNull String schemaName) {
         ...
         * @return this
         */
        public Builder typeConvert(@NonNull ITypeConvert typeConvert) {
         ...
         * @return this
         */
        public Builder keyWordsHandler(@NonNull IKeyWordsHandler keyWordsHandler) {
