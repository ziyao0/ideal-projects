...
public class AuthorizationRecordServiceImpl extends JapServiceImpl
        <AuthorizationRecordRepositoryJpa, AuthorizationRecord, Integer> implements AuthorizationRecordService {
